  ...
  <div>
    ...
    <div>
      <v-container  grid-list-sm>
        <v-btn color="deep-purple lighten-1" dark><v-icon left class="mt-1">blur_on</v-icon>趋势</v-btn>
        <h2 class="mt-3">今日 <v-chip>{{ month }}月{{ day }}日</v-chip></h2>
    ...
    <div class="text-xs-center">
      <v-btn large round outline v-on:click="fetchPage(page + 1)">加载更多 </v-btn>
    </div>
  </div>
</template>
